...
Ruby-Wallet provides is capable of providing complete access to any of the Bitcoin based coind JSON-RPC API. Ruby-Wallet 
organizies the features within a secure wallet abstraction, giving safe access to the the wallet from ruby.
...
Add the following to your Gemfile
  ...
  gem "ruby-wallet", :git => "https://github.com/ruby-wallet/ruby-wallet.git", require: "coin"
