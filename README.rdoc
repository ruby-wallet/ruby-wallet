...
Also considering building out a sinatra API for the higher levels of the stack to communicate with. This would allow this abstraction to be more flexible in stack placement.
