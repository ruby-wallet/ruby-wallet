...
You will need to clone the repo, copy the sample config files to make config files. Then compile the gem and install it locally.

== Usage

The simplest possible usage

  RubyWallet.connect(rpc_user: 'coinrpc', rpc_password: 'rpcpassword', rpc_host: "blackwavelabs.com", rpc_port: "8332", rpc_ssl: true).balance
  # => 0.001
